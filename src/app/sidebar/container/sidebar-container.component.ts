...
@Component({
	selector: 'kryptand-sidebar-container',
	template: `
    <div *ngIf="showBackdrop"
      aria-hidden="true"
      class="backdrop"
      [ngClass]="backdropClass"
      (click)="backdropClicked()"></div>

    <ng-content select="kryptand-sidebar,[kryptand-sidebar]"></ng-content>

    <div class="content"
      [class.animate]="animate"
      [ngClass]="contentClass"
      [ngStyle]="getContentStyle()">
      <ng-content select="[kryptand-sidebar-content]"></ng-content>
    </div>
  `,
	styles: [
		`
